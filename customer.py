...
class Customer_Window:
    def __init__(self, root):
        ...
        combo_Nationality=ttk.Combobox(labelframeleft,textvariable=self.var_natinality,font=("arial",12,"bold"),width=27,state="readonly") 
        ...
        combo_id["value"]=("AadharCard","PAN","Driving Licence","Passport")
        combo_id.current(0)
